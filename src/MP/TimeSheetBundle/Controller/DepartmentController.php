...
use MP\TimeSheetBundle\Form\DepartmentType;
...
class DepartmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MPTimeSheetBundle:Department')->findAll();

        return $this->render('MPTimeSheetBundle:Department:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MPTimeSheetBundle:Department:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MPTimeSheetBundle:Department')->find($id);
        ...
        return $this->render('MPTimeSheetBundle:Department:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MPTimeSheetBundle:Department:edit.html.twig', array(
            'entity'      => $entity,
